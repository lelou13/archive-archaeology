    ...
    <td>
      <center>
        <font face="Arial" size="-1">
          <strong>Wireless Journal</strong>
        </font>
      </center>
    </td>
  </tr>
...
<?
  ...
  if ($HTTP_GET_VARS["id"]=="1" && $journal_name != "" && $journal_msg != "") {
    ...
    $query = "INSERT INTO journal (journal_name, journal_email, journal_msg, journal_date, user_ip) VALUES ('$new_journal_name','$new_journal_email','$new_journal_msg','".date("Y-m-d h:i:s")."','".$HTTP_SERVER_VARS['REMOTE_ADDR']."')";
...
?>
  <tr>
    <td align="left">
      <font face="Arial" size="1">
        <a href="journal.htm">Add Journal Entry</a>
        &nbsp; &nbsp; &nbsp;
<?
  if($pg!=1) {
?>
