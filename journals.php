                    ...
                    <tr>
                      <td align="left" valign="top"> <!-- InstanceBeginEditable name="Content " -->
                        <table width="100%" border="0" cellpadding="14" cellspacing="0" class="text">
                          <tr> 
                            <td colspan="2" align="left" valign="top"><h1>Wireless 
                                Journals <br />
                              </h1></td>
                          </tr>
                          <tr> 
                            <td width="59%" align="left" valign="top"><div align="center"> 
                                <p align="left"><a href="http://wireless_archaeology.csumb.edu/journal/carmel_journal.php">San 
                                  Carlos Borromeo del Rio Carmelo Journal </a></p>
                                <p align="left"><a href="http://wireless_archaeology.csumb.edu/journal/sjb_journal.php">San 
                                  Juan Bautista Journal </a></p>
<p align="left"><a href="http://wireless_archaeology.csumb.edu/journal/presidio_journal.php">Royal Presidio of Monterey</a></p>
<p align="left"><a href="http://wireless_archaeology.csumb.edu/journal/soledad_journal.php">Mission Nuestra Señora de la Soledad</a></p>
                                <p align="left"><a href="http://wireless_archaeology.csumb.edu/journal/view_journal.php">Wireless 
                                  Journal</a> </p>
                              </div></td>
                            <td width="41%" align="left" valign="top"><p><img src="images/MendozaRainTarp4_25_03.jpg" width="162" height="124" class="images-border" /><br />
                                <br />
                                <span class="images-text">Professor Mendoza prepares 
                                a Wireless Journal entry during the course of 
                                a torrential downpour. In order to safely prepare 
                                said entry, Mendoza is shielded with what remained 
                                of the project canopy -- destroyed by high winds.</span></p>
                              </td>
                          </tr>
                        </table>
