                    ...
                    <tr>
                      <td align="left" valign="top"> <!-- InstanceBeginEditable name="Content " -->
                        <table width="100%" border="0" cellpadding="14" cellspacing="0" class="text">
                          <tr> 
                            <td align="left" valign="top"><h1>What's New: Wireless 
                                Project Updates</h1></td>
                          </tr>
                          <tr> 
                            <td align="left" valign="top"> <div align="left">
                                <p class="bold">Carmel Mission Archaeological 
                                  Project</p>
                                <p>Wireless Journal entries found here span the 
                                  period encompassing project startup in the Spring 
                                  of 2003 at site CA-MNT-18 (San Carlos Borromeo 
                                  del Rio Carmelo).<br>
                                  ::<a href="archive01.php"> see more</a></p>
                                <p class="bold">Wireless Demonstration Project</p>
                                <p> Wireless Journal Entries found here are specific 
                                  to the experimental and pedagogical dimensions 
                                  of the Wireless Technologies in Archaeology 
                                  Demonstration Project based on both CSU Monterey 
                                  Bay campus and Mission Research Program field 
                                  reports at Carmel and San Juan Bautista.<br>
                                  ::<a href="archive02.php"> see more</a></p>
                                </div></td>
                          </tr>
                        </table>
